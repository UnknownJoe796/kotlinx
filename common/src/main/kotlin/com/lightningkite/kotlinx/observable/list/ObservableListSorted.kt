...
import com.lightningkite.kotlinx.collection.mapping
import com.lightningkite.kotlinx.collection.mappingMutable
...
class ObservableListSorted<E>(val source: ObservableList<E>, val sorter: (E, E) -> Boolean) : ObservableList<E>, Closeable {
    ...
    override fun iterator(): MutableIterator<E> = indexList.iterator().mappingMutable({ source[it] })
