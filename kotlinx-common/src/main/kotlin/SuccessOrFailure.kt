///*
// * Shim until released - Joseph Ivie
//
...
// */
//public class SuccessOrFailure<out T> @PublishedApi internal constructor(
...
// */
//public inline fun <R> runCatching(block: () -> R): SuccessOrFailure<R> {
//    return try {
...
// */
//public inline fun <T, R> T.runCatching(block: T.() -> R): SuccessOrFailure<R> {
//    return try {
//        SuccessOrFailure.success(block())
//    } catch (e: Throwable) {
//        SuccessOrFailure.failure(e)
...
// */
//public inline fun <R, T : R> SuccessOrFailure<T>.getOrElse(onFailure: (exception: Throwable) -> R): R {
//    return when(value) {
...
// */
//public inline fun <R, T> SuccessOrFailure<T>.fold(
//        onSuccess: (value: T) -> R,
...
// */
//public inline fun <R, T> SuccessOrFailure<T>.map(transform: (value: T) -> R): SuccessOrFailure<R> {
//    return when(value) {
...
// */
//public inline fun <R, T> SuccessOrFailure<T>.mapCatching(transform: (value: T) -> R): SuccessOrFailure<R> {
//    return when(value) {
//        is SuccessOrFailure.Failure -> SuccessOrFailure(value)
...
// */
//public inline fun <R, T: R> SuccessOrFailure<T>.recover(transform: (exception: Throwable) -> R): SuccessOrFailure<R> {
//    return when(value) {
...
// */
//public inline fun <R, T: R> SuccessOrFailure<T>.recoverCatching(transform: (exception: Throwable) -> R): SuccessOrFailure<R> {
...
// */
//public inline fun <T> SuccessOrFailure<T>.onFailure(action: (exception: Throwable) -> Unit): SuccessOrFailure<T> {
...
// * Returns the original `SuccessOrFailure` unchanged.
// */
//public inline fun <T> SuccessOrFailure<T>.onSuccess(action: (value: T) -> Unit): SuccessOrFailure<T> {
